...
KindEditor.plugin('flash', function(K) {
	var self = this, name = 'flash', lang = self.lang(name + '.'),
		...
		extraParams = K.undef(self.extraFileUploadParams, {'fileType': 'media'}),
		filePostName = K.undef(self.filePostName, 'imgFile'),
		//uploadJson = K.undef(self.uploadJson, self.basePath + 'php/upload_json.php');
		uploadJson = K.undef(self.uploadJson, '/Index/oss/upload_json');
	self.plugin.flash = {
		edit : function() {
			var html = [
...
KindEditor.plugin('image', function(K) {
	var self = this, name = 'image',
		...
		extraParams = K.undef(self.extraFileUploadParams, {'fileType': 'images'}),
		filePostName = K.undef(self.filePostName, 'imgFile'),
...
KindEditor.plugin('multiimage', function(K) {
	...
	self.plugin.multiImageDialog = function(options) {
		...
		var swfupload = K.swfupload({
			...
			postParams :  K.undef(self.extraFileUploadParams, {'fileType': 'images'}),
